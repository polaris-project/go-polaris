...
type Crypto interface {
	AddressFromPrivateKey(context.Context, *GeneralRequest) (*GeneralResponse, error)
...
func (c *cryptoProtobufClient) AddressFromPrivateKey(ctx context.Context, in *GeneralRequest) (*GeneralResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "crypto")
	ctx = ctxsetters.WithServiceName(ctx, "Crypto")
	ctx = ctxsetters.WithMethodName(ctx, "AddressFromPrivateKey")
...
func (c *cryptoProtobufClient) AddressFromPublicKey(ctx context.Context, in *GeneralRequest) (*GeneralResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "crypto")
	ctx = ctxsetters.WithServiceName(ctx, "Crypto")
	ctx = ctxsetters.WithMethodName(ctx, "AddressFromPublicKey")
	out := new(GeneralResponse)
...
func (c *cryptoProtobufClient) Sha3(ctx context.Context, in *GeneralRequest) (*GeneralResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "crypto")
	ctx = ctxsetters.WithServiceName(ctx, "Crypto")
...
func (c *cryptoJSONClient) AddressFromPrivateKey(ctx context.Context, in *GeneralRequest) (*GeneralResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "crypto")
	ctx = ctxsetters.WithServiceName(ctx, "Crypto")
	ctx = ctxsetters.WithMethodName(ctx, "AddressFromPrivateKey")
	out := new(GeneralResponse)
...
func (c *cryptoJSONClient) AddressFromPublicKey(ctx context.Context, in *GeneralRequest) (*GeneralResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "crypto")
	ctx = ctxsetters.WithServiceName(ctx, "Crypto")
	ctx = ctxsetters.WithMethodName(ctx, "AddressFromPublicKey")
	out := new(GeneralResponse)
...
func (c *cryptoJSONClient) Sha3(ctx context.Context, in *GeneralRequest) (*GeneralResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "crypto")
	ctx = ctxsetters.WithServiceName(ctx, "Crypto")
	ctx = ctxsetters.WithMethodName(ctx, "Sha3")
	out := new(GeneralResponse)
...
func NewCryptoServer(svc Crypto, hooks *twirp.ServerHooks) TwirpServer {
	return &cryptoServer{
		Crypto: svc,
		hooks:  hooks,
	}
...
func (s *cryptoServer) writeError(ctx context.Context, resp http.ResponseWriter, err error) {
	writeError(ctx, resp, err, s.hooks)
}

// CryptoPathPrefix is used for all URL paths on a twirp Crypto server.
// Requests are always: POST CryptoPathPrefix/method
// It can be used in an HTTP mux to route twirp requests along with non-twirp requests on other routes.
const CryptoPathPrefix = "/twirp/crypto.Crypto/"

func (s *cryptoServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	ctx := req.Context()
	ctx = ctxsetters.WithPackageName(ctx, "crypto")
	ctx = ctxsetters.WithServiceName(ctx, "Crypto")
	...
	switch req.URL.Path {
	case "/twirp/crypto.Crypto/AddressFromPrivateKey":
		s.serveAddressFromPrivateKey(ctx, resp, req)
		return
	case "/twirp/crypto.Crypto/AddressFromPublicKey":
		s.serveAddressFromPublicKey(ctx, resp, req)
		return
...
func (s *cryptoServer) serveAddressFromPrivateKey(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	case "application/json":
		s.serveAddressFromPrivateKeyJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveAddressFromPrivateKeyProtobuf(ctx, resp, req)
	default:
...
func (s *cryptoServer) serveAddressFromPrivateKeyJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "AddressFromPrivateKey")
	...
	func() {
		...
		respContent, err = s.Crypto.AddressFromPrivateKey(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *GeneralResponse and nil error while calling AddressFromPrivateKey. nil responses are not supported"))
		return
	}
...
func (s *cryptoServer) serveAddressFromPrivateKeyProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "AddressFromPrivateKey")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *cryptoServer) serveAddressFromPublicKey(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveAddressFromPublicKeyJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveAddressFromPublicKeyProtobuf(ctx, resp, req)
	default:
		msg := fmt.Sprintf("unexpected Content-Type: %q", req.Header.Get("Content-Type"))
		twerr := badRouteError(msg, req.Method, req.URL.Path)
		s.writeError(ctx, resp, twerr)
...
func (s *cryptoServer) serveAddressFromPublicKeyJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "AddressFromPublicKey")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	func() {
		...
		respContent, err = s.Crypto.AddressFromPublicKey(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *GeneralResponse and nil error while calling AddressFromPublicKey. nil responses are not supported"))
		return
	}
...
func (s *cryptoServer) serveAddressFromPublicKeyProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "AddressFromPublicKey")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *cryptoServer) serveSha3(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveSha3JSON(ctx, resp, req)
	case "application/protobuf":
		s.serveSha3Protobuf(ctx, resp, req)
	default:
		msg := fmt.Sprintf("unexpected Content-Type: %q", req.Header.Get("Content-Type"))
		twerr := badRouteError(msg, req.Method, req.URL.Path)
		s.writeError(ctx, resp, twerr)
...
func (s *cryptoServer) serveSha3JSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Sha3")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	func() {
		...
		respContent, err = s.Crypto.Sha3(ctx, reqContent)
	}()
...
func (s *cryptoServer) serveSha3Protobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Sha3")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *cryptoServer) ServiceDescriptor() ([]byte, int) {
	return twirpFileDescriptor0, 0
}

func (s *cryptoServer) ProtocGenTwirpVersion() string {
	return "v5.4.2"
}
