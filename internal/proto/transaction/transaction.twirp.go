...
func (c *transactionProtobufClient) NewTransaction(ctx context.Context, in *GeneralRequest) (*GeneralResponse, error) {
...
func (c *transactionJSONClient) NewTransaction(ctx context.Context, in *GeneralRequest) (*GeneralResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "transaction")
	ctx = ctxsetters.WithServiceName(ctx, "Transaction")
	ctx = ctxsetters.WithMethodName(ctx, "NewTransaction")
	out := new(GeneralResponse)
...
func (s *transactionServer) serveNewTransaction(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	case "application/json":
		s.serveNewTransactionJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveNewTransactionProtobuf(ctx, resp, req)
	default:
...
func (s *transactionServer) serveNewTransactionJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "NewTransaction")
	...
	func() {
		...
		respContent, err = s.Transaction.NewTransaction(ctx, reqContent)
	}()
...
func (s *transactionServer) serveNewTransactionProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "NewTransaction")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
